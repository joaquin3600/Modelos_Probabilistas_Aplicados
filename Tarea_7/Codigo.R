...
#4) Correlacion Test  #################
      ...
      #              legend = c("regresión lineal", "regresión local"),
      #              col    = c("red", "blue"),
      #              lty    = 1:2,
      #              cex    = 0.8)
...
#8) Correlacion Ejemplos  #################
      ...
      png(filename  = "CorrelacionCurva.png",
          width  = 500             ,
          height = 800)
...
#9) Correlacion Ejemplos Lineal #################
      ...
      png(filename  = "SinTransformada.png",
          width  = 800             ,
          height = 500)
      ...
      plot(x, y,
           ...
           panel.first = grid())
           legend(min(x) , max(y),
             legend = c("Vector sin transformada"),
             col    = c("black","red"),
             lty    = 1:3,
             cex    = 0.8)
      regression lineal
      ...
      png(filename  = paste("Lambda", i,".png", sep=""),
          width  = 800             ,
          height = 500)

        opar=par(ps=18)

        text <- paste("Lambda = ", i, sep=" ")
...
#10) Correlacion Ejemplos Lineal #################
